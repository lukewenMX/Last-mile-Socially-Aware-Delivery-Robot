...
public:
     ...
     */
    bool pickup_trajectory(const std::vector<MotionModelDiffDrive::Trajectory>&, const Eigen::Vector3d&, const MotionModelDiffDrive::Trajectory&, MotionModelDiffDrive::Trajectory&, double);

    double calculate_diff_trajectory(const MotionModelDiffDrive::Trajectory & , const MotionModelDiffDrive::Trajectory &);
     ...
     */
    bool check_collision(const state_lattice_planner::ObstacleMap<int>&, MotionModelDiffDrive::Trajectory&);
    /**
